export default async function handler(req, res) {
  ...
  const { bodyPart, painIntensity, history } = req.body;

  const system = bodyPart
    ? `You are a helpful AI health assistant. The user has pain or discomfort in their ${bodyPart} with a pain intensity of ${painIntensity}/10.
...
YOUR FLOW:
Step 1 — Ask 1-2 short follow-up questions to understand the symptoms better. Consider the pain intensity level in your questions. Do not give any diagnosis yet.
